...
def main_corrected_ensemblTree():	
	...
	for x in glob.glob("clusters_100_0/fuzzyCMeans/*_nj_1_root.nhx"): 
	#for x in glob.glob("clusters_100_0/fuzzyCMeans/ENSGT00390000016811_cluster_1_root.nhx"): 
		print(x)
		cmpt += 1
		...
		if os.stat("ensemblGeneTree/sequences_100_0/" +x + "_stats.txt").st_size != 0:	
			print("******************************************************************")			
			continue
		...
		i = 1
		while os.path.exists("clusters_100_0/fuzzyCMeans/" + x + "_nj_" + str(i) + "_root.nhx") and  os.path.exists("clusters_100_0/fuzzyCMeans/" + x + "_cluster_" + str(i) + "_root.nhx"):
			trees_build_by_nj.append("clusters_100_0/fuzzyCMeans/" + x + "_nj_" + str(i) + "_root.nhx")		
			trees_build_by_orthoGroup.append("clusters_100_0/fuzzyCMeans/" + x + "_cluster_" + str(i) + "_root.nhx")
			break
			i += 1
		...
		seqFileUsedByOrthoGroup = open("ensemblGeneTree/sequences_100_0/" + x + "_ByOrthoGroup.fasta", "w")

		#Sequence file containing the longest CDS of each gene by EnsemblGene Tree
		seqFileUsedByEnsemblGeneTree = open("ensemblGeneTree/sequences_100_0/" + x + "_ByEnsemblGeneTree.fasta", "w")
		...
		stat_file = open("ensemblGeneTree/sequences_100_0/" + x + "_stats.txt", "w")
		...
		all_trees = open("ensemblGeneTree/trees_100_0/" + x + ".nw", "w")
		...
		mafft_cline1 = MafftCommandline(input="ensemblGeneTree/sequences_100_0/" + x + "_ByOrthoGroup.fasta")
		mafft_cline2 = MafftCommandline(input="ensemblGeneTree/sequences_100_0/" + x + "_ByEnsemblGeneTree.fasta")
		stdout1, stderr1 = mafft_cline1()
		stdout2, stderr2 = mafft_cline2()


		
		with open("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByOrthoGroup.fasta", "w") as handle: 
			 handle.write(stdout1)

		with open("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByEnsemblGeneTree.fasta", "w") as handle: 
			 handle.write(stdout2)

		main_fasta_to_phylip_one("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByOrthoGroup.fasta", "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy")
		main_fasta_to_phylip_one("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByEnsemblGeneTree.fasta", "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy")
		


		os.system("PhyML-3.1/PhyML-3.1_linux64 -i " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + " -u " + "ensemblGeneTree/trees_100_0/" + x + ".nw"  + " -o lr --print_site_lnl --no_memory_check --quiet -d aa")

		os.system("ensemblGeneTree/consel/bin/makermt --phyml " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk.txt")

		os.system("ensemblGeneTree/consel/bin/consel "+ "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk")

		os.system("ensemblGeneTree/consel/bin/catpv " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk.pv -s 1 > " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy"+ "._seq_OrthoGroup_consel")
		
		#print("PhyML-3.1/PhyML-3.1_linux64 -i " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + " -u " + "ensemblGeneTree/trees_100_0/" + x + ".nw"  + " -n 1 -o lr --print_site_lnl --no_memory_check --quiet -d aa")

		#print("ensemblGeneTree/consel/bin/makermt --phyml " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk.txt")

		#print("ensemblGeneTree/consel/bin/consel "+ "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk")

		#print("ensemblGeneTree/consel/bin/catpv " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy" + "_phyml_lk.pv -s 1 > " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy"+ "._seq_OrthoGroup_consel")

		#exit()
		"""
		print("PhyML-3.1/PhyML-3.1_linux64 -i " + "ensemblGeneTree/sequences_100_0/" + x + "_2_Aln.phy" + " -u " + "ensemblGeneTree/trees_100_0/" + x + ".nw"  + " -n 1 -o lr --print_site_lnl --no_memory_check --quiet -d aa")

		print("ensemblGeneTree/consel/bin/makermt --phyml " + "ensemblGeneTree/sequences_100_0/" + x + "_2_Aln.phy" + "_phyml_lk.txt")

		print("ensemblGeneTree/consel/bin/consel "+ "ensemblGeneTree/sequences_100_0/" + x + "_2_Aln.phy" + "_phyml_lk")

		print("ensemblGeneTree/consel/bin/catpv " + "ensemblGeneTree/sequences_100_0/" + x + "_2_Aln.phy" + "_phyml_lk.pv -s 1 > " + "ensemblGeneTree/sequences_100_0/" + x + "_2_Aln.phy"+ "._seq_Ensembl_consel")			
		"""
		"""
		os.system("PhyML-3.1/PhyML-3.1_linux64 -i " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy" + " -u " + "ensemblGeneTree/trees_100_0/" + x + ".nw"  + " -o lr --print_site_lnl --no_memory_check --quiet -d aa")

		os.system("ensemblGeneTree/consel/bin/makermt --phyml " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy" + "_phyml_lk.txt")

		os.system("ensemblGeneTree/consel/bin/consel "+ "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy" + "_phyml_lk")

		os.system("ensemblGeneTree/consel/bin/catpv " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy" + "_phyml_lk.pv -s 1 > " + "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy"+ "._seq_Ensembl_consel")			
		"""
	print(cmpt)
...
def main_corrected_reconstructEnsemblTree():	
	...
	for x in glob.glob("/home/local/USHERBROOKE/kuie2201/Bureau/MarieDegen/SpliceGraph/ensemblGeneTree/sequences_100_0/*_root.nhx"): 
	#for x in glob.glob("clusters_100_0/fuzzyCMeans/ENSGT00390000016811_cluster_1_root.nhx"): 
		print(x)
		cmpt += 1
		...
		all_trees = open("ensemblGeneTree/trees_100_0/" + x + ".nw", "a")
		...
		#with open("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByEnsemblGeneTree.fasta", "w") as handle: 
		#	 handle.write(stdout2)
		#print("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByOrthoGroup.fasta", "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy")
		#main_fasta_to_phylip_one("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByOrthoGroup.fasta", "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByOrthoGroup.phy")
		#main_fasta_to_phylip_one("ensemblGeneTree/sequences_100_0/" + x + "_Alni_ByEnsemblGeneTree.fasta", "ensemblGeneTree/sequences_100_0/" + x + "_Aln_ByEnsemblGeneTree.phy")
